---
title: 'Lista 4 - Métodos Quantitativos IPOL/UnB'
...
# Legendas e justificativa teórica

## Legendas para criação do índice 
Legendas do índice para entender a mudança de foco e predominância do texto constitucional ligado a cada uma das categorias

- Executive = quantidade de palavras destinada à categoria "Executive" em cada constituição
- Legislative = quantidade de palavras destinada à categoria "Legislative" em cada constituição
- Judicial = quantidade de palavras destinada à categoria "Judicial" em cada constituição
- Poderes = somatório das palavras destinadas aos três poderes - Executivo + Legislativo + Judiciário - em cada constituição
...
```{r grafico 1, echo = FALSE, fig.height=5, fig.width=8, fig.align= 'center'}
...
## GRÁFICO 2 - Índices Legislativo, Executivo e Judiciário por ano constitucional

```{r echo=FALSE, fig.height=5, fig.width=10, message=FALSE, fig.align= 'center'}
...
```{r grafico 5, echo=FALSE, fig.height=5, fig.width=10, fig.align= 'center'}
constituicoes_poderes %>%
